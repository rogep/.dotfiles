...
vim.keymap.set('n', '<leader>ws', "<CMD>lua require('telescope').extensions.git_worktree.git_worktrees()<CR>", { desc = 'Switch worktrees', silent = true })

-- tmux
vim.keymap.set('n', '<leader>t', '<CMD>!tmux neww ~/.local/scripts/tmux-sessioniser<CR>', { desc = 'tmux sessioniser', silent = true, noremap = true })
-- [[ Basic Autocommands ]]
